...
export const metadata: Metadata = {
  ...
  description:
    "Transfer text between devices instantly. Share clipboard content and notes via temporary links. Free and secure.",
  alternates: { canonical: "https://send-anywhere-text.com/text-transfer" },
  keywords:
...
<p>Text transfer is moving text from one device to another. SnapText makes this effortless - you paste your text, get a link, and open it on any device.</p>

<h2>How Text Transfer Works</h2>
<p>Transfer text between devices:</p>
<ol>
<li>Paste text on the source device</li>
<li>Generate a transfer link</li>
<li>Open the link on the target device</li>
<li>Copy the received text</li>
</ol>

<h2>Text Transfer Use Cases</h2>
<h3>Device to Device</h3>
<p>Share text between your phone and computer, laptop and tablet, or any other devices. No cables or sync required.</p>

<h3>Clipboard Sharing</h3>
<p>Copy text on one device and transfer it to another. Perfect for moving content between work and personal devices.</p>

<h3>Structured Text Transfer</h3>
<p>Move copied instructions, logs, or config text between devices. No email, no USB, and no account setup - just a link.</p>
...
<li><strong>Formatting preserved:</strong> Works for plain and structured text</li>
</ul>

<h2>Text Transfer for Developers</h2>
<ul>
<li>Transfer error logs</li>
<li>Send config values</li>
