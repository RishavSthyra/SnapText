...
export const metadata: Metadata = {
  ...
  description:
    "Share text instantly with temporary links. No signup, no fees—just paste text and share a link. Perfect for code snippets, passwords, and quick notes.",
  alternates: { canonical: "https://send-anywhere-text.com/instant-text-share"}, keywords:
...
<h3>Code Snippets</h3>
<p>Share code instantly with preserved formatting. Paste your snippet, share the link, recipient gets perfect code.</p>
...
<p>Share URLs in contexts where link-clickable text isn't possible. Convert to text, share via link.</p>
...
<li><strong>Code-friendly:</strong> Preserves indentation and formatting</li>
...
<li>Distribute config files</li>
<li>Send API examples</li>
...
<li><strong>No logs:</strong> We don't track your shares</li>
...
<p>Don't complicate simple sharing. Paste your text, get a link, share it anywhere. Instant text sharing with SnapText—fast, free, and private.</p>
`;
